...
import { allUsers, updateProfile, blockProfile, deleteAvatar } from "../../actions/users";
...
const UserEditor = () => {
  ...
  const allUsersList = useSelector((state) => state.user.listUsers); //Получаем из редюсера список пользователей
