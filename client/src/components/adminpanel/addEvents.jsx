...
import { uploadAttachmentEvents } from "../../actions/events";
...
const AddEvents = () => {
  ...
  function addEventsNow() {
    ...
    if (file != null) {
      ...
      dispatch(uploadAttachmentEvents(file, attachmentName));
    } else {
      attachmentName = "";
    }
    ...
    if (text1 != "" && text2 != "" && date != "") {
      ...
      addEvents(text1, text2, date, attachmentName);
    } else {
  ...
  return (
    <div className="modal fade" id="addEventsModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div className="modal-content">
          ...
          <div className="modal-body">
            ...
            <div className="d-grid gap-2 d-md-blockr overflow-hidden">
              <button className="btn btn-primary" type="button" id="button_auth" onClick={() => addEventsNow()}>
                Сохранить
              </button>
            </div>
          </div>
