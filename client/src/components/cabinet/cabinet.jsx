...
const Cabinet = () => {
  ...
  const [emailNew, setEmail] = useState(currentEmail);
  const [passwordNew, setPassword] = useState("");
  const [nameNew, setName] = useState(currentName);

  //Вызов функции для получения истории брионирования
  useEffect(() => {
    dispatch(allBookings(currentID));
            ...
            <div className="row align-item-start">
              <div className="col">
                ...
                <div className="mb-3">
                  ...
                  <Input className="form-control form-control-sm" value={nameNew} setValue={setName} type="text" />
                </div>
                <div className="mb-3">
                  <label className="form-label">Email-адрес: </label>
                  <Input className="form-control form-control-sm" value={emailNew} setValue={setEmail} type="text" />
                </div>
                <div className="mb-3">
                  <label htmlFor="exampleInputPassword1" className="form-label">
                    Пароль
                  </label>
                  <Input className="form-control form-control-sm" value={passwordNew} setValue={setPassword} type="password" placeholder="********" />
                </div>
                <div className="mb-3">
                  <button type="button" className="btn btn-primary btn-sm" onClick={() => updateProfile(currentID, emailNew, passwordNew, nameNew)}>
                    Сохранить профиль
                  </button>
                </div>
              </div>
              ...
              <div className="col">
                ...
                <div className="crop">
                  ...
                  <img className="rounded" src={avatar} id="avatar" alt={currentID} onError={(e) => ((e.target.onerror = null), (e.target.src = avatarDefault))} />
                </div>
                <div className="mb-3">
                  <p />
